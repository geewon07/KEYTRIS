...
import start from "../../assets/imgs/GameStart.png";
import input from "../../assets/imgs/GameInput.png";
import sort from "../../assets/imgs/GameSort.png";
import over from "../../assets/imgs/GameOver.png";
...
export const ModalGameRule = ({ isOpen, onClose }) => {
  ...
  const descriptions =`[시작하기] 버튼을 클릭해 게임을 시작하세요.
    ...
    입력단어와 유사도 순으로 제시어들이 재정렬됩니다<br /> 타겟어가 목표 순위내에 들어온다면 단어가 제거되고 점수를 얻을 수 있습니다.
